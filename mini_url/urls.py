...
urlpatterns = [
    ...
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', {'template_name': 'mini_url/registration/password_reset_confirm.html'}, auth_views.password_reset_confirm, name='password_reset_confirm'),
    ...
    url(r'^login/$', auth_views.login, {'template_name': 'mini_url/registration/login.html'}, name='login'),
